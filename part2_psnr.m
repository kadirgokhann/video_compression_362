...
GOPS1_               = Compression.CompressImproved(framesInMacroBlocks);
reconstructed_GOPS1  = Decompression.ConvertToImg(Decompression.DecompressImproved(GOPS1_));

Constants.SET_GOP_SIZE(15);
GOPS15_              = Compression.CompressImproved(framesInMacroBlocks);
reconstructed_GOPS15 = Decompression.ConvertToImg(Decompression.DecompressImproved(GOPS15_));

Constants.SET_GOP_SIZE(30);
GOPS30_              = Compression.CompressImproved(framesInMacroBlocks);
reconstructed_GOPS30 = Decompression.ConvertToImg(Decompression.DecompressImproved(GOPS30_));
